...
export const resolveReport = (reportId, adminNote, takeAction = false) =>
  api.put(`/admin/reports/${reportId}/resolve`, { adminNote, takeAction });
export const dismissReport = (reportId, adminNote) =>
  api.put(`/admin/reports/${reportId}/dismiss`, { adminNote });
